...
import FadeIn from '@/components/FadeIn'; // <--- Import Komponen Baru
import MagneticButton from '@/components/MagneticButton'; // <--- Import Komponen Baru
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen overflow-hidden relative bg-light-bg dark:bg-dark-bg transition-colors duration-300">
      ...
      {/* ================= HERO SECTION ================= */}
      {/* Hero menggunakan animasi bawaan (initial/animate) karena muncul pertama kali */}
      <section id="home" className="min-h-screen flex items-center justify-center px-6 pt-20 relative z-10">
        ...
        <div className="max-w-5xl mx-auto text-center flex flex-col items-center">
          ...
          <motion.div
            ...
            className="mb-4"
          >
            <span className="px-4 py-2 rounded-full bg-accent-primary/10 text-accent-primary border border-accent-primary/20 text-sm font-medium backdrop-blur-sm">
              Hello, I'm
            </span>
          </motion.div>
          ...
          {/* Title */}
          <motion.h2
             className="text-xl md:text-2xl font-semibold mb-8 text-text-light-secondary dark:text-text-dark-secondary"
             initial={{ opacity: 0, y: 20 }}
             animate={{ opacity: 1, y: 0 }}
      ...
      <section id="projects" className="py-24 px-6 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Grid Projects dengan Staggered FadeIn */}
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <FadeIn delay={0.2}>
            <div className="text-center mb-16">
              ...
              <a href="#contact" className="inline-flex items-center gap-2 text-accent-primary font-medium hover:underline text-lg">
      ...
      {/* ================= CONTACT SECTION (4 ITEMS WITH GITHUB) ================= */}
      <section id="contact" className="py-24 px-6 relative z-10">
         <div className="max-w-6xl mx-auto">
            <FadeIn>
              <div className="p-8 md:p-12 rounded-3xl border border-accent-primary/20 bg-light-card/50 dark:bg-dark-card/50 backdrop-blur-lg shadow-2xl text-center">
                
                <h2 className="text-3xl md:text-5xl font-bold mb-6 text-text-light-primary dark:text-text-dark-primary">
                  Let's Connect
                </h2>
                <p className="text-lg text-text-light-secondary dark:text-text-dark-secondary mb-10 max-w-2xl mx-auto">
                  I'm currently looking for new opportunities. Whether you have a question or just want to say hi, I'll try my best to get back to you!
                </p>
                
                {/* Grid Kartu Kontak: 1 Kolom (HP) -> 2 Kolom (Tablet) -> 4 Kolom (Desktop) */}
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  
                  {/* 1. EMAIL */}
                  <a 
                    href={`mailto:${profileData.email}`}
                    className="flex flex-col items-center p-6 rounded-xl bg-light-surface/50 dark:bg-dark-surface/50 border border-light-border dark:border-dark-border hover:border-accent-primary/50 hover:bg-accent-primary/5 transition-all group"
                  >
                    <div className="p-4 rounded-full bg-accent-primary/10 text-accent-primary mb-4 group-hover:scale-110 transition-transform">
                      <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                      </svg>
                    </div>
                    <h3 className="font-bold text-text-light-primary dark:text-text-dark-primary mb-1">Email</h3>
                    <span className="text-sm text-text-light-secondary dark:text-text-dark-secondary break-all">
                      Send Mail
                    </span>
                  </a>
                  ...
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex flex-col items-center p-6 rounded-xl bg-light-surface/50 dark:bg-dark-surface/50 border border-light-border dark:border-dark-border hover:border-[#0077b5]/50 hover:bg-[#0077b5]/5 transition-all group"
                  >
                    <div className="p-4 rounded-full bg-[#0077b5]/10 text-[#0077b5] mb-4 group-hover:scale-110 transition-transform">
                      <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                      </svg>
                    </div>
                    <h3 className="font-bold text-text-light-primary dark:text-text-dark-primary mb-1">LinkedIn</h3>
                  ...
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex flex-col items-center p-6 rounded-xl bg-light-surface/50 dark:bg-dark-surface/50 border border-light-border dark:border-dark-border hover:border-text-light-primary/50 hover:bg-text-light-primary/5 dark:hover:border-white/50 dark:hover:bg-white/5 transition-all group"
                  >
                    <div className="p-4 rounded-full bg-black/10 text-black dark:bg-white/10 dark:text-white mb-4 group-hover:scale-110 transition-transform">
                      <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 className="font-bold text-text-light-primary dark:text-text-dark-primary mb-1">GitHub</h3>
                    <span className="text-sm text-text-light-secondary dark:text-text-dark-secondary">
                      Check Code
                    </span>
                  </a>
                  ...
                  <a 
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex flex-col items-center p-6 rounded-xl bg-light-surface/50 dark:bg-dark-surface/50 border border-light-border dark:border-dark-border hover:border-[#25D366]/50 hover:bg-[#25D366]/5 transition-all group"
                  >
                    <div className="p-4 rounded-full bg-[#25D366]/10 text-[#25D366] mb-4 group-hover:scale-110 transition-transform">
                       <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <h3 className="font-bold text-text-light-primary dark:text-text-dark-primary mb-1">WhatsApp</h3>
                    <span className="text-sm text-text-light-secondary dark:text-text-dark-secondary">
                      Chat Me
                    </span>
                  </a>
